...
Users can seamlessly switch between five distinct 3D arrangements:
...
* **Pyramid (New):** A **4-face Tetrahedron** formed by mathematically stacking triangular layers of decreasing size (1, 3, 6, 10...) to a single peak.
...
├── script.js    # Core logic: Auth, Data, Pyramid & Layout Math
...
* **Mathematical Layouts:** The Pyramid layout uses a nested loop algorithm to calculate `(x, y, z)` offsets, ensuring items are centered relative to the row below them for a perfect stack.
